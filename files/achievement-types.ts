...
export type RequirementType =
  ...
  | "specific_skill"
  | "streak_days"
  | "exercise_reps"        // reps for a specific exercise type
  | "hang_time_seconds"
  | "endgame_count"
  | "all_endgame"
  | "all_achievements"
...
export interface AchievementDef {
  ...
  hint?:       string;        // shown for secret achievements (optional)
}
...
export interface AchievementStats {
  ...
  recentlyUnlocked: string[];   // achievement ids, most recent first
}
